      ...
      <div className="container mx-auto px-6">
        ...
        >
          <a
            href="#/resources"
            onClick={handleBack}
            className="text-brand-green hover:text-green-400 transition-colors duration-300 flex items-center gap-2 font-orbitron"
          >
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <motion.div variants={fadeIn('up', 0.3)} className="mb-12">
                <h2 className="text-2xl font-orbitron font-bold text-white mb-4">Overview</h2>
              ...
              {resource.features && resource.features.length > 0 && (
                <motion.div variants={fadeIn('up', 0.5)} className="mb-12">
                  <h2 className="text-2xl font-orbitron font-bold text-white mb-4">Features</h2>
              ...
              {resource.requirements && resource.requirements.length > 0 && (
                <motion.div variants={fadeIn('up', 0.6)} className="mb-12">
                  <h2 className="text-2xl font-orbitron font-bold text-white mb-4">Requirements</h2>
                  <div className="bg-gradient-to-br from-gray-900/80 to-gray-900/50 border border-gray-700/30 p-6">
                    <ul className="space-y-3">
              ...
              {resource.includesFiles && resource.includesFiles.length > 0 && (
                <motion.div variants={fadeIn('up', 0.7)} className="mb-12">
                  <h2 className="text-2xl font-orbitron font-bold text-white mb-4">What's Included</h2>
                  <div className="bg-gradient-to-br from-gray-900/80 to-gray-900/50 border border-gray-700/30 p-6">
                    <ul className="space-y-3">
              ...
              <div className="bg-gradient-to-br from-gray-900/80 to-gray-900/50 border border-gray-700/30 p-8 mb-6">
                <div className="text-center mb-6">
                  ...
                  <motion.a
                    ...
                    className="block w-full px-8 py-4 bg-brand-green text-dark-bg font-orbitron font-bold text-lg hover:bg-green-400 transition-colors flex items-center justify-center gap-2"
              ...
              <div className="bg-gradient-to-br from-gray-900/80 to-gray-900/50 border border-gray-700/30 p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {resource.tags.map((tag) => (
                    <span
                      key={tag}
                      className="px-3 py-1 bg-gray-800/50 text-gray-300 text-sm border border-gray-700/50 hover:border-brand-green/50 transition-colors cursor-pointer"
                    >
                      {tag}
                    </span>
                  ))}
