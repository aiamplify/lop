  ...
  return (
    <section id="about" className="py-24 animate-fade-in overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        >
          <a href="#" onClick={handleNavigateToHome} className="text-brand-orange hover:underline mb-8 inline-block font-heading">
            &larr; Back to Home
          </a>
        </motion.div>
        ...
        >
          ...
          >
            Where <span className="text-brand-orange font-bold">creativity meets technology</span> to amplify your brand and elevate your impact.
          </motion.p>
        </motion.div>
        ...
        >
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="text-center p-8 bg-gradient-to-br from-gray-900/80 to-gray-800/50 border border-gray-700/50 hover:border-brand-orange/50 transition-all duration-300 group"
            >
              <div className="text-5xl mb-4 group-hover:scale-110 transition-transform duration-300">{stat.icon}</div>
              <div className="text-4xl md:text-5xl font-heading font-bold text-brand-orange mb-2">{stat.value}</div>
        ...
        >
          ...
          <motion.div variants={slideIn('right', 'spring', 0.2, 0.8)} className="text-gray-300 text-lg leading-relaxed space-y-6">
            <h3 className="text-4xl font-heading text-white mb-6 bg-gradient-to-r from-white to-brand-orange bg-clip-text text-transparent">Who We Are</h3>
            <p className="text-xl">
              Quantum Canvas helps <span className="text-brand-orange font-semibold">small- to medium-sized businesses</span> stand out with bold, strategic design. We specialize in branding, logo design, marketing graphics, social media creatives, and AI-powered design solutions.
            </p>
            <p className="text-xl">
              Our mission is to <span className="text-brand-orange font-semibold">amplify business potential</span> with design that connects, inspires trust, and drives results.
            </p>
            <div className="border-l-4 border-brand-orange pl-6 py-4 bg-gray-900/30">
        ...
        >
          <motion.h3
            variants={fadeIn('down', 0)}
            className="text-4xl md:text-5xl font-heading text-white text-center mb-16"
          >
            Our Core Values
          </motion.h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <motion.div
                ...
                className="p-8 bg-gradient-to-br from-gray-900/80 to-gray-800/50 border border-gray-700/50 hover:border-brand-orange/50 transition-all duration-300 group hover:transform hover:-translate-y-2"
              >
                <div className="text-5xl mb-4 group-hover:scale-110 transition-transform duration-300">{value.icon}</div>
                <h4 className="text-2xl font-heading text-brand-orange mb-4">{value.title}</h4>
        ...
        >
          ...
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-brand-orange via-green-600 to-brand-orange/20"></div>
              ...
              {timeline.map((item, index) => (
                ...
                >
                  <div className={`flex-1 ${index % 2 === 0 ? 'text-right' : 'text-left'}`}>
                    <div className="p-6 bg-gradient-to-br from-gray-900/80 to-gray-800/50 border border-gray-700/50 hover:border-brand-orange/50 transition-all duration-300 inline-block">
                      <h4 className="text-3xl font-heading text-brand-orange mb-2">{item.year}</h4>
                      <h5 className="text-xl font-bold text-white mb-3">{item.title}</h5>
                      <p className="text-gray-400">{item.description}</p>
                    </div>
                  </div>
                  <div className="w-6 h-6 bg-brand-orange rounded-full border-4 border-dark-bg z-10 flex-shrink-0 animate-pulse"></div>
        ...
        >
          <motion.div variants={slideIn('left', 'spring', 0, 0.8)} className="text-gray-300 text-lg leading-relaxed space-y-6 order-2 md:order-1">
            <h3 className="text-4xl font-heading text-white mb-6 bg-gradient-to-r from-white to-brand-orange bg-clip-text text-transparent">Meet Mike Eckmeier</h3>
            <p className="text-xl">
              Mike is the <span className="text-brand-orange font-semibold">founder and creative director</span> of Quantum Canvas. He blends traditional design principles with cutting-edge AI tools to deliver high-quality, fast results for entrepreneurs and local businesses.
            </p>
            <p className="text-xl">
              Passionate about making great design accessible, Mike believes design is more than visuals—it's about <span className="text-brand-orange font-semibold">helping businesses grow with confidence</span>.
            </p>
            ...
            <div className="flex gap-4 items-center">
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-brand-orange text-dark-bg font-heading font-bold hover:bg-green-400 transition-colors"
              >
        ...
        >
          ...
          <div className="relative z-10">
            <h3 className="text-4xl md:text-5xl font-heading text-white mb-6">Ready to Amplify Your Brand?</h3>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-10 leading-relaxed">
              If your visuals aren't telling your story or winning you customers, let's fix that. <span className="text-brand-orange font-semibold">Your brand deserves better.</span>
            </p>
            <a
              href="#contact"
