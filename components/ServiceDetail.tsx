      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center w-20 h-20 mx-auto mb-6 bg-brand-orange/10 border-2 border-brand-orange/30">
              <div className="w-10 h-10 text-brand-orange">
                {getIcon()}
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            ...
            <div className="bg-gray-900/50 p-8 border border-gray-700/50">
              <h2 className="text-2xl font-heading font-bold text-white mb-6">Our Process</h2>
              <ol className="space-y-4">
                {service.process.map((step, index) => (
                  <li key={index} className="flex items-start text-gray-300">
                    <span className="flex items-center justify-center w-8 h-8 bg-brand-orange/10 border border-brand-orange/30 text-brand-orange font-heading text-sm mr-4 flex-shrink-0">
                      {index + 1}
                    </span>
          ...
          <div className="text-center bg-gray-900/50 p-12 border border-gray-700/50">
            <h3 className="text-3xl font-heading text-white mb-6">Ready to Get Started?</h3>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto mb-8">
              Let's discuss how this service can help amplify your brand and achieve your business goals.
            </p>
            <a href="#contact" className="inline-block px-8 py-4 bg-brand-orange text-dark-bg font-heading font-bold hover:bg-green-400 transition-colors">
              Get a Quote
            </a>
          </div>
        </div>
